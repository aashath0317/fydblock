...
import {
    Bell, Plus, Search, Pause, Activity, Loader2
} from 'lucide-react';
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-8 relative z-10">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { name: "SPOT DCA", type: "DCA" },
                            { name: "SPOT GRID", type: "GRID" },
                            { name: "Future Grid", type: "FUTURES" },
                            { name: "Future DCA", type: "DCA" }
                        ].map((bot, i) => (
                            <div
                                key={i}
                            ...
                            >
                                <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform group-hover:bg-[#00FF9D] group-hover:text-black border border-white/5 group-hover:border-[#00FF9D]">
                                    <Plus size={24} className="text-[#00FF9D] group-hover:text-black" />
                                </div>
                                <span className="font-bold text-white tracking-widest text-xs uppercase">{bot.name}</span>
                            </div>
                        ))}
                    </div>
                </section>
