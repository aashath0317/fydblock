  ...
  return (
    <div className="pt-32 pb-20 relative z-10 animate-in fade-in duration-500">
      <div className="container mx-auto px-6">
        ...
        {/* --- Contact Card --- */}
        <div className="bg-[#1f2937]/50 backdrop-blur-md border border-white/10 rounded-2xl p-3 max-w-6xl mx-auto shadow-2xl flex flex-col lg:flex-row gap-4 overflow-hidden mb-24">
          ...
          {/* Right Side - Form */}
          <div className="lg:w-2/3 p-8 lg:p-12 bg-[#050B0D]/20">
            <form className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-xs text-[#00FF9D] font-medium">First Name</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs text-[#00FF9D] font-medium">Last Name</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs text-[#00FF9D] font-medium">Email</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs text-[#00FF9D] font-medium">Phone Number</label>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-6">
                  {['General Inquiry', 'Technical Support', 'Billing & Payments', 'Bot Setup'].map((opt, i) => (
                    <label key={i} className="flex items-center gap-2 cursor-pointer group">
                      <input type="radio" name="subject" className="peer sr-only" />
                      <div className="w-4 h-4 rounded-full border border-gray-500 peer-checked:bg-[#00FF9D] peer-checked:border-[#00FF9D] relative transition-all">
              ...
              <div className="space-y-2">
                <label className="text-xs text-[#00FF9D] font-medium">Message</label>
        ...
        <div className="mt-20 max-w-6xl mx-auto bg-gradient-to-r from-[#00FF9D]/20 to-[#00A3FF]/20 border border-[#00FF9D]/30 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
        ...
        {/* --- Newsletter Section --- */}
        <div className="mt-16 max-w-6xl mx-auto h-[300px] rounded-3xl relative overflow-hidden flex items-center justify-center text-center bg-gradient-to-b from-[#00FF9D]/10 to-[#050B0D]">
...
const SocialIcon = ({ icon }) => (
  <div className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#00FF9D] hover:text-black flex items-center justify-center transition-colors cursor-pointer text-white">
    {icon}
  </div>
);
