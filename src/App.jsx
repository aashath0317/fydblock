...
const LandingPage = () => {
  return (
    <>
      ...
      {/* --- Globe & Social Proof --- */}
      <section className="py-32 relative overflow-hidden z-10 min-h-[800px]">
        {/* Globe Background */}
        ...
        {/* Content Container */}
        <div className="container mx-auto px-6 relative z-10 h-full flex flex-col items-center">
          
          {/* Top Text Section (Centered Above Globe) */}
          <div className="max-w-3xl text-center mt-12 mb-auto">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 drop-shadow-lg">
              Used by 10,000+ <br/>
              Traders around the World
            </h2>
            <p className="text-gray-300 font-medium text-lg drop-shadow-md mb-8">
              Join a global community of smart investors trading from over 150 countries.
            </p>
          ...
          {/* Review Card - Positioned to the Right Side */}
          <div className="w-full flex justify-center md:justify-end mt-20 md:mt-0 md:absolute md:right-10 md:bottom-32">
            <div className="bg-[#0A1014]/80 backdrop-blur-md p-6 rounded-2xl border border-white/10 max-w-sm shadow-2xl relative">
              ...
              <p className="text-gray-300 italic text-left">"I've tried 3Commas and Cryptohopper, but FydBlock's interface is by far the most intuitive. My DCA bots have been running for 3 months with consistent profits."</p>
            </div>
          </div>
        </div>
      </section>
